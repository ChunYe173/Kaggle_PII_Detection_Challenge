...
def tokenize_and_align_labels(examples, tokenizer, label2id, max_length):
    ...
    for i, label in enumerate(examples["provided_labels"]):
        ...
        for word_idx in word_ids:  # Set the special tokens to -100.
            print("Next word id: ", word_idx)
            print("Next word id: ", type(word_idx))
            if word_idx is None:
...
def main(training, training_model_path, training_max_length, path_to_datasets, model_save_path):
    ...
    # should we remove punctuations from each tokens in the above step?
    ...
    args = TrainingArguments(
        ...
        # seed=1,
        save_total_limit=3, # if set to 1, this makes load_best_model_at_end redundant
